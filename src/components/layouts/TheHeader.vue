<template>
    <div
        style="width: calc(100vw - 241px); height: 60px"
        class="fixed top-0 right-0 z-10 flex items-center justify-between px-7"
    >
        <!-- back and forward -->
        <div class="flex items-center h-full">
            <div class="flex space-x-3">
                <a
                    href="#"
                    style="padding: 5px"
                    class="bg-black rounded-full opacity-90"
                    ><svg
                        role="img"
                        focusable="false"
                        height="24"
                ...
                <a
                    href="#"
                    style="padding: 5px"
                    class="bg-black rounded-full opacity-60"
                    ><svg
                        role="img"
                        focusable="false"
                        height="24"
        ...
        <!-- profile section -->
        <button
            class="flex items-center p-1 space-x-2 rounded-full bg-name-section hover:bg-name-hover focus:outline-none"
        >
            <div style="background: #333" class="p-1.5 rounded-full">
                <svg
                    width="16"
                    height="16"
                    fill="currentColor"
            ...
            <span class="text-sm font-bold truncate w-28">Nguyen Nhat Hao</span>
